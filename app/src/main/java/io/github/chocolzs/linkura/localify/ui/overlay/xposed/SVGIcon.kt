...
object SVGIcon {
    ...
    object Refresh {
        fun createDrawable(context: Context, tintColor: Int = Color.WHITE, sizeDp: Float = 24f): Drawable {
            val pathData = "M12 20q-3.35 0-5.675-2.325T4 12t2.325-5.675T12 4q1.725 0 3.3.712T18 6.75V4h2v7h-7V9h4.2q-.8-1.4-2.187-2.2T12 6Q9.5 6 7.75 7.75T6 12t1.75 4.25T12 18q1.925 0 3.475-1.1T17.65 14h2.1q-.7 2.65-2.85 4.325T12 20"
            return createSVGDrawable(context, pathData, tintColor, sizeDp)
        }
    }
}